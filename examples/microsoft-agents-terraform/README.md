...
# Microsoft-Hosted Agents with Terraform

This example uses Microsoft-hosted (GitHub-hosted) agents with Terraform pipelines. No self-hosted compute infrastructure is created.
