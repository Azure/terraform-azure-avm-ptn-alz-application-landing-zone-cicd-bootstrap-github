...
This minimal example creates a single environment with subscription scope, a single write identity, and a custom workflow that authenticates to Azure and creates a resource group.
